...
//----------------------------------------------
TuiBtnStg5::TuiBtnStg5( TsceneStageSelect *select, const Vector2D &pos, const Vector2D &velocity)
	:TobjUi(
	select,
	pos,						// position
	0,							// radius
...
//----------------------------------------------
TuiBtnStg5::~TuiBtnStg5(void)
{
}

//----------------------------------------------
BOOL TuiBtnStg5::Update(double time_elapsed)
{
...
void TuiBtnStg5::Render( void )
{
	...
	// 画像を表示する座標
	FpStageSelect->FpBtnStg5->RenderEx(
							&srcRec,
							pos,																// DrawPosition
