...
//----------------------------------------------
TuiBtnStg1::TuiBtnStg1( TsceneStageSelect *select, const Vector2D &pos, const Vector2D &velocity)
	:TobjUi(
	select,
	pos,						// position
	0,							// radius
...
//----------------------------------------------
TuiBtnStg1::~TuiBtnStg1(void)
{
}

//----------------------------------------------
BOOL TuiBtnStg1::Update(double time_elapsed)
{
...
void TuiBtnStg1::Render( void )
{
	...
	// 画像を表示する座標
	FpStageSelect->FpBtnStg1->RenderEx(
							&srcRec,
							pos,																// DrawPosition
