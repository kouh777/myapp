...
//----------------------------------------------
TenemBossAlbert::TenemBossAlbert( TsceneGame *game, const int &pattern, const Vector2D &pos, const Vector2D &velocity )
	:TobserverEnemy(
	game,
	pos,						// position
	2.0,						// radius
...
//----------------------------------------------
TenemBossAlbert::~TenemBossAlbert(void)
{
	// スクリプトを再開する
	FpGame->ScriptResume();
}
...
//----------------------------------------------
void TenemBossAlbert::Initialize(void)
{
}

//---------------------------------------------
BOOL TenemBossAlbert::Update(double time_elapsed)
{
	if( !FbInitializeFlg){
		Initialize();
...
//---------------------------------------------
void TenemBossAlbert::Render( void )
{
...
//---------------------------------------------------------------------
// Cgdi描画
void TenemBossAlbert::RenderCgdi()
{
	TBaseMovingObject::RenderCgdi();	
}

//---------------------------------------------
void TenemBossAlbert::RecieveNotify( TBaseSubjectObject *sub )
{
...
//---------------------------------------------------------------------
// 衝突処理
void TenemBossAlbert::ReactHit(double damage){
