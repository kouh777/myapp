...
//----------------------------------------------
TenemBossShadowVisor::TenemBossShadowVisor( TsceneGame *game, const int &pattern, const Vector2D &pos, const Vector2D &velocity )
	:TobserverEnemy(
	game,
	pos,						// position
	2.0,						// radius
...
//----------------------------------------------
TenemBossShadowVisor::~TenemBossShadowVisor(void)
{

}

//----------------------------------------------
void TenemBossShadowVisor::Initialize(void)
{
}

//---------------------------------------------
BOOL TenemBossShadowVisor::Update(double time_elapsed)
{
	if( !FbInitializeFlg){
		Initialize();
...
//---------------------------------------------
void TenemBossShadowVisor::Render( void )
{
	...
	// 画像を表示する座標
	FpGame->FpBossShadowVisor->RenderEx(
							&srcRec,
							pos,												// DrawPosition
...
//---------------------------------------------------------------------
// Cgdi描画
void TenemBossShadowVisor::RenderCgdi()
{
	TBaseMovingObject::RenderCgdi();	
}

//---------------------------------------------
void TenemBossShadowVisor::RecieveNotify( TBaseSubjectObject *sub )
{
...
//---------------------------------------------------------------------
// 衝突処理
void TenemBossShadowVisor::ReactHit(double damage){
