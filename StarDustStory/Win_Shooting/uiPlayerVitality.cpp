...
#define TRIMMING__IMAGE_LTY_WAKU 81		//@‘Ì—ÍƒQ[ƒW˜gØ‚èŽæ‚è LeftTop
#define TRIMMING__IMAGE_RBY_WAKU 162	//  ‘Ì—ÍƒQ[ƒW˜gØ‚èŽæ‚è RightBottom
#define TRIMMING__IMAGE_LTY_EMP	162		//  ‘Ì—ÍƒQ[ƒW‹ó‚Á‚ÛØ‚èŽæ‚è LeftTop
#define TRIMMING__IMAGE_RBY_EMP	243		//  ‘Ì—ÍƒQ[ƒW‹ó‚Á‚ÛØ‚èŽæ‚è RightBottom
...
{
	// Å‘å‘Ì—Í‚©‚ç‚Ý‚½Œ»Ý‚ÌƒvƒŒƒCƒ„[‘Ì—Í‚ÌŠ„‡
	if( FpGame->pPlayer ){
...
void TuiPlayerVitality::Render( void )
{
	...
	// ƒQ[ƒW‚Ì’†g
	RECT InGaugeRec =  { TRIMMING__IMAGE_LTX, TRIMMING__IMAGE_LTY, TRIMMING__IMAGE_RBX * FdPlayerPerLife, TRIMMING__IMAGE_RBY};						// ‰æ‘œ‚Ì’†‚©‚çØ‚èŽæ‚éÀ•W
