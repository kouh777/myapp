...
//---------------------------------------------------------------------
#define TRIMMING__IMAGE_LTX 313	// 
#define TRIMMING__IMAGE_LTY 10	// 
#define TRIMMING__IMAGE_RBX 495	// 
#define TRIMMING__IMAGE_RBY 144	//

//---------------------------------------------------------------------
// enemBossSpaceShipからどれだけ離れているか距離を定義
#define FROM_SPACESHIP_X 0
#define FROM_SPACESHIP_Y 0

//----------------------------------------------
TenemBossBody::TenemBossBody( TsceneGame *game, const int &pattern, const Vector2D &pos, const Vector2D &velocity )
	:TsubjectEnemy(
	game,
	pos,						// position
	1.0,						// radius
...
//----------------------------------------------
TenemBossBody::~TenemBossBody(void)
{

}

//---------------------------------------------
BOOL TenemBossBody::Update(double time_elapsed)
{
...
//---------------------------------------------
void TenemBossBody::Render( void )
{
...
//---------------------------------------------
// Reccieve Notify
void TenemBossBody::RecieveNotify( TBaseObserverObject *obs)
{
