...
//----------------------------------------------
TuiBtnStg2::TuiBtnStg2( TsceneStageSelect *select, const Vector2D &pos, const Vector2D &velocity)
	:TobjUi(
	select,
	pos,						// position
	0,							// radius
...
//----------------------------------------------
TuiBtnStg2::~TuiBtnStg2(void)
{
}

//----------------------------------------------
BOOL TuiBtnStg2::Update(double time_elapsed)
{
...
void TuiBtnStg2::Render( void )
{
	...
	// 画像を表示する座標
	FpStageSelect->FpBtnStg2->RenderEx(
							&srcRec,
							pos,																// DrawPosition
