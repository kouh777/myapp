...
//----------------------------------------------
TenemBossUnderson::TenemBossUnderson( TsceneGame *game, const int &pattern, const Vector2D &pos, const Vector2D &velocity )
	:TobserverEnemy(
	game,
	pos,						// position
	2.0,						// radius
...
//----------------------------------------------
TenemBossUnderson::~TenemBossUnderson(void)
{
	// スクリプトを再開する
	FpGame->ScriptResume();
}
...
//----------------------------------------------
void TenemBossUnderson::Initialize(void)
{
}

//---------------------------------------------
BOOL TenemBossUnderson::Update(double time_elapsed)
{
	if( !FbInitializeFlg){
		Initialize();
...
//---------------------------------------------
void TenemBossUnderson::Render( void )
{
	...
	// 画像を表示する座標
	FpGame->FpBossUnderson->RenderEx(
							&srcRec,
							pos,												// DrawPosition
...
//---------------------------------------------------------------------
// Cgdi描画
void TenemBossUnderson::RenderCgdi()
{
	TBaseMovingObject::RenderCgdi();	
}

//---------------------------------------------
void TenemBossUnderson::RecieveNotify( TBaseSubjectObject *sub )
{
...
//---------------------------------------------------------------------
// 衝突処理
void TenemBossUnderson::ReactHit(double damage){
