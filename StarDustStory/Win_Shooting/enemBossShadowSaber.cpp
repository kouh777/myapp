...
//----------------------------------------------
TenemBossShadowSaber::TenemBossShadowSaber( TsceneGame *game, const int &pattern, const Vector2D &pos, const Vector2D &velocity )
	:TobserverEnemy(
	game,
	pos,						// position
	2.0,						// radius
...
//----------------------------------------------
TenemBossShadowSaber::~TenemBossShadowSaber(void)
{
	// スクリプトを再開する
	FpGame->ScriptResume();
}
...
//----------------------------------------------
void TenemBossShadowSaber::Initialize(void)
{
}

//---------------------------------------------
BOOL TenemBossShadowSaber::Update(double time_elapsed)
{
	if( !FbInitializeFlg){
		Initialize();
...
//---------------------------------------------
void TenemBossShadowSaber::Render( void )
{
	...
	// 画像を表示する座標
	FpGame->FpBossShadowSaber->RenderEx(
							&srcRec,
							pos,												// DrawPosition
...
//---------------------------------------------------------------------
// Cgdi描画
void TenemBossShadowSaber::RenderCgdi()
{
	TBaseMovingObject::RenderCgdi();	
}

//---------------------------------------------
void TenemBossShadowSaber::RecieveNotify( TBaseSubjectObject *sub )
{
...
//---------------------------------------------------------------------
// 衝突処理
void TenemBossShadowSaber::ReactHit(double damage){
