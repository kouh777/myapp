...
//----------------------------------------------
TuiBtnShion::TuiBtnShion( TsceneStageSelect *select, const Vector2D &pos, const Vector2D &velocity)
	:TobjUi(
	select,
	pos,						// position
	0,							// radius
...
//----------------------------------------------
TuiBtnShion::~TuiBtnShion(void)
{
}

//----------------------------------------------
BOOL TuiBtnShion::Update(double time_elapsed)
{
...
void TuiBtnShion::Render( void )
{
	...
	// 画像を表示する座標
	FpStageSelect->FpBtnShion->RenderEx(
							&srcRec,
							pos,																// DrawPosition
